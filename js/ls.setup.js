(function (config) {
	if (typeof config !== 'undefined') {
		...
		config.checkIfMobile = function (a) {
		...
		config.setSmartPreload = function () {
			if (config.preloadAfterLoad === 'smart') {
				return (! config.checkIfMobile(navigator.userAgent || navigator.vendor || window.opera) ).toString();
			}
		};

		config.setSmartPreload();
	}
